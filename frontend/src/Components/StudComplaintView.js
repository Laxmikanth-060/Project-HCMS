...
<div className='flex justify-center mt-3 mx-[50px]'>
  <div className='bg-teal-500 rounded-full h-[150px] w-[150px] m-4 mx-10'><div className='absolute text-lg text-slate-950 font-semibold mt-12 ml-[34px]'><h1>Electrical</h1><h1 className='text-center'>{electrical}</h1></div></div>
  <div className='bg-amber-200 rounded-full h-[150px] w-[150px] m-4 mx-10'><div className='absolute mt-12 ml-[33px] text-slate-950 font-semibold text-lg'><h1>Carpenter</h1><h1 className='text-center'>{carpenter}</h1></div></div>
  <div className='bg-stone-400 rounded-full h-[150px] w-[150px] m-4 mx-10'><div className='absolute mt-12 ml-[36px] text-slate-950 font-semibold text-lg'><h1>Cleaning</h1><h1 className='text-center'>{cleaning}</h1></div></div>
  <div className='bg-violet-400 rounded-full h-[150px] w-[150px] m-4 mx-10'><div className='absolute mt-12 ml-[45px] text-slate-950 font-semibold text-lg'><h1>Others</h1><h1 className='text-center'>{others}</h1></div></div>
</div>


     <h2 className='text-center text-2xl font-bold mt-6'>Total Complaints</h2>
  <div className='flex justify-center'>
  <table className='mt-7 border border-black'>
