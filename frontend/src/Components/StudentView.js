...
<div className='flex justify-center mt-3 '>
  ...
  <div className='bg-red-500 rounded-full h-[150px] w-[150px] m-4 mx-10'><div className='absolute mt-12 ml-[38px] text-slate-950 font-semibold text-lg'><h1>Pending</h1><h1 className='text-center'>{pending}</h1></div></div>
        ...
        <Link to="/student/raisecomplaint"><div className='bg-violet-500 text-2xl border border-black-100 w-80 h-14 hover:cursor-pointer text-center my-7 shadow-sm hover:scale-105 hover:bg-violet-700 ml-28 rounded-md' onClick={e=>setTemp("ok")}><h1 className='mt-3'>Register Complaint</h1></div></Link>
        <Link to="/student/viewcomplaint"><div className='bg-violet-500 text-2xl border border-black-100 w-80 h-14 hover:cursor-pointer text-center my-7 shadow-sm hover:scale-105 hover:bg-violet-700 mr-28 rounded-md' onClick={e=>setTemp("ok")}><h1 className='mt-3'>View Status</h1></div></Link>
